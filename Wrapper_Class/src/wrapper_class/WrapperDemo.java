...
public class WrapperDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Comparing using compareTo Obj1 and Obj3: " + intObj1.compareTo(intObj3)); // 2compareTo1 = 1, 1compareTo2 = -1, 
        ...
        System.out.println("Comparing using compareTo f1 and f2: " + f1.compareTo(f2));
        System.out.println("Comparing using compareTo f1 and f3: " + f1.compareTo(f3));
        //same        
